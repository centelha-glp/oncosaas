...
from .clinical_evolution_orders import router as clinical_evolution_orders_router
...
router.include_router(clinical_evolution_orders_router, dependencies=_auth)
